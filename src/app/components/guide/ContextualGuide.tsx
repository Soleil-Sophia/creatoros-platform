...
const SHARED_TOPICS: GuideTopic[] = [
  {
    ...
    title: 'Evidence',
    explanation:
      'Evidence is information that supports or weakens a recommendation. Examples include previous content performance, clicks, leads, sales, audience feedback, and repeated patterns across similar content.',
  ...
  },
  {
    ...
    explanation:
      'Confidence shows how strongly the available information supports a recommendation. Medium means the recommendation is plausible but needs more real results. High means several relevant signals point in the same direction.',
  ...
  },
  {
    ...
    explanation:
      'CreatorOS starts with a reasonable first estimate. Every new result updates that estimate. One successful post is a clue, not proof. Repeated similar results make the conclusion stronger; conflicting results make it weaker.',
      ...
      topics: [
        {
          ...
          explanation:
            'CreatorOS combines your brand context, audience, offer, business goal, channel, format, and available evidence. It then returns one clear action instead of a generic list of ideas.',
        ...
        },
        {
          ...
          explanation:
            'Choose the result the content should support. Reach attracts relevant attention. Authority builds trust. Lead generation creates qualified enquiries. Sales helps warm audiences decide. Community deepens participation.',
      ...
      topics: [
        {
          ...
          title: 'Brand tone',
          explanation:
            'Your brand tone is the consistent way your brand sounds. Start with how people should feel after reading your content: informed, reassured, motivated, challenged, inspired, or understood.',
          nextStep: 'Choose three primary traits and two things the brand should avoid. Example: direct, intelligent, encouraging; avoid exaggerated promises and forced humour.',
        },
        {
          id: 'positioning',
          ...
          title: 'Positioning',
          explanation:
            'Positioning explains who the brand helps, which important problem it solves, how it solves it differently, and why the audience should care.',
        ...
        },
        {
          ...
          explanation:
            'Allowed claims are statements the brand is permitted to make and can support. Prohibited claims are promises, exaggerations, or sensitive statements the brand should not publish.',
      ...
      topics: [
        {
          ...
          explanation:
            'Check the prefilled offer, audience, goal, tone, platform, and format. Generate the content, review it for accuracy and brand fit, then save the approved output to the Content Library.',
        ...
        },
        {
          ...
          explanation:
            'Use short scripts for concise video, hook packs for testing openings, captions for text-led posts, briefs for deeper production, and repurposing plans when one strong idea should become several assets.',
        },
        ...SHARED_TOPICS,
      ],
    };
      ...
      topics: [
        {
          ...
          explanation:
            'A recommendation snapshot freezes the original goal, reasoning, confidence, policy result, and measurement plan at the moment the asset is created.',
...
export function ContextualGuide() {
  ...
  const context = useMemo(
    () => resolveGuideContext(typeof window === 'undefined' ? '/' : window.location.pathname),
    [isOpen],
  );
    ...
    <>
      <button
        ...
        style={{
          ...
          background: 'linear-gradient(135deg, rgba(255,191,222,0.96), rgba(218,191,255,0.96))',
          color: '#171923',
      ...
      {isOpen && (
        <div
          ...
          style={{
            ...
            background: 'linear-gradient(145deg, #1F2230, #14161F)',
            boxShadow: '0 28px 80px rgba(0,0,0,0.58)',
            color: '#F4F3F8',
          }}
        >
          <div style={{ padding: 20, borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
            <div style={{ color: '#DABFFF', fontSize: 11, fontWeight: 800, letterSpacing: '0.09em', textTransform: 'uppercase' }}>
              {context.area} · {context.page}
            </div>
            <h2 style={{ margin: '8px 0 8px', fontSize: 20 }}>How can I help?</h2>
            ...
            {selectedTopic ? (
              <div>
                <button
                  ...
                  style={{ border: 0, background: 'transparent', color: '#DABFFF', padding: 0, fontSize: 12, cursor: 'pointer' }}
                >
                  ← Back to questions
                </button>
